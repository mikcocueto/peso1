...
<div class="site-wrap">
  ...
  <div class="container">
        ...
        <div class="row mb-5">
          ...
          <div class="col-6 col-md-3 mb-4 mb-md-0">
            ...
            <ul class="list-unstyled">
              ...
              <li><a href="#blogs">Announcement</a></li>
              <li><a href="#">Blog</a></li>
                        ...
                        <div class="job-card">
                            ...
                            <div class="job-content">
                                ...
                                ${<?php echo isset($_SESSION['user_id']) ? 'true' : 'false'; ?> ? `
                                    <button 
                                        class="btn btn-save-job ${<?php echo json_encode($saved_jobs); ?>.includes(job.job_id) ? 'saved' : ''}" 
    ...
    function toggleSaveJob(button) {
        ...
        fetch("includes/employee/save_job_process.php", {
            method: "POST",
